			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-3 col-lg-2 text-center text-md-start">
						<div v-if="FT_Heading" class="heading">{{ FT_Heading }}</div>
						<hr class="heading__he">
						<!-- <div
						...
						<div v-if="FT_Tel || FT_Email"
							class="flex flex-col gap-2 sm:gap-3 md:gap-4 pt-4 sm:pt-6 md:pt-9">
							<div v-if="FT_Tel">
								<a :href="'tel:' + FT_Tel" class="link">
									<svg class="link__icon" width="36" height="36" viewBox="0 0 36 36" fill="none"
			...
			<div class="container">
				<div class="row">
					<div class="offset-sm-1 col-sm-2">
						<div v-if="FB_Content">{{ currentYear }} - {{ FB_Content }}</div>
					</div>
					<div class="col-1">
						<div class="custom__image col-span-4 lg:col-span-1 h-full">
