...
<template>
	<footer id="contact" class="overflow-hidden">
		<div class="bg-gray-100 text-sm md:text-base" :class="[FT_Padding]">
			<div class="container grid md:grid-cols-4 gap-y-4 gap-x-10">
				...
				<div class="md:col-span-3 lg:col-span-2 text-center md:text-start">
					<div v-if="FT_Heading" class="heading text-lg sm:text-xl md:text-2xl uppercase">{{ FT_Heading }}
					</div>
					<div
		...
		<div class="bg-gray-900 text-gray-100 text-xs sm:text-sm md:text-base text-center">
