...
<template>
	<footer id="contact" class="overflow-hidden">
		...
		pt-6 sm:pt-10 md:pt-16 xl:pt-20
		pb-10 sm:pb-16 md:pb-20 xl:pb-24">
			<div class="container
			grid
			md:grid-cols-4
			gap-y-4 gap-x-10">
			...
			gap-y-4 gap-x-10">
				...
				pointer-events-none">
					<img src="/assets/img/footer_img.png" alt="Footer sushi" class="absolute
						bottom-0
						-start-1/2 md:-start-2/3 lg:-start-1/2 xxl:-start-1/3
						h-[160px] sm:h-[260px] md:h-[360px] lg:h-[500px]
						max-h-none
						max-w-none">
				</div>
			</div>
